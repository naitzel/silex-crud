...
$app->register(new Adris\SilexCrud\Provider\SessionServiceProvider());

// http://silex.sensiolabs.org/doc/providers/form.html
$app->register(new Adris\SilexCrud\Provider\FormServiceProvider());

// http://silex.sensiolabs.org/doc/providers/translation.html
$app->register(new Adris\SilexCrud\Provider\TranslationServiceProvider());

// http://silex.sensiolabs.org/doc/providers/validator.html
$app->register(new Adris\SilexCrud\Provider\ValidatorServiceProvider());

// http://silex.sensiolabs.org/doc/providers/url_generator.html
$app->register(new Adris\SilexCrud\Provider\UrlGeneratorServiceProvider());

// http://silex.sensiolabs.org/doc/providers/doctrine.html
$app->register(new Adris\SilexCrud\Provider\DoctrineServiceProvider());

// http://silex.sensiolabs.org/doc/providers/swiftmailer.html
$app->register(new Adris\SilexCrud\Provider\SwiftmailerServiceProvider());

// http://silex.sensiolabs.org/doc/providers/service_controller.html
$app->register(new Adris\SilexCrud\Provider\ServiceControllerServiceProvider());

// http://silex.sensiolabs.org/doc/providers/security.html#traits
$app->register(new Adris\SilexCrud\Provider\RouteProvider());

// ExceptionServiceProvider
$app->register(new Adris\SilexCrud\Provider\ExceptionServiceProvider());

// http://silex.sensiolabs.org/doc/providers/twig.html
$app->register(new Adris\SilexCrud\Provider\TwigServiceProvider());

// http://silex.sensiolabs.org/doc/providers/http_fragment.html
$app->register(new Silex\Provider\HttpFragmentServiceProvider());

// http://glide.thephpleague.com/
$app->register(new Adris\SilexCrud\Provider\GlideProvider());

// S.E.O. Provider
$app->register(new Adris\SilexCrud\Provider\SeoProvider());
...
// Serviço Banner
$app->register(new \Adris\SilexCrud\Provider\BannerProvider());
$app->register(new \Adris\SilexCrud\Provider\BannerTypeProvider());
